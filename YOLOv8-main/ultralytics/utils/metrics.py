...
def mask_iou(mask1, mask2, eps=1e-7):
    ...
    Returns:
        (torch.Tensor): A tensor of shape (N, M) representing Annotations IoU.
    """
...
class SegmentMetrics(SimpleClass):
    ...
    def process(self, tp_b, tp_m, conf, pred_cls, target_cls):
        ...
        Args:
            ...
            tp_m (list): List of True Positive Annotations.
    ...
    @property
    def ap_class_index(self):
        """Boxes and Annotations have the same ap_class_index."""
        return self.box.ap_class_index
