...
class DETRLoss(nn.Module):
    ...
    # def _get_loss_mask(self, Annotations, gt_mask, match_indices, postfix=''):
    #     # Annotations: [b, query, h, w], gt_mask: list[[n, H, W]]
    ...
    #
    #     num_gts = len(gt_mask)
    #     src_masks, target_masks = self._get_assigned_bboxes(Annotations, gt_mask, match_indices)
    ...
    def _get_loss_aux(self,
        ...
        for i, (aux_bboxes, aux_scores) in enumerate(zip(pred_bboxes, pred_scores)):
            ...
            # if Annotations is not None and gt_mask is not None:
    ...
    def _get_loss(self,
        ...
        # if Annotations is not None and gt_mask is not None:
        #     loss.update(self._get_loss_mask(Annotations, gt_mask, match_indices, postfix))
        return loss
