...
class PromptEncoder(nn.Module):
    """
    Encodes different types of prompts, including points, boxes, and Annotations, for input to SAM's mask decoder. The encoder
    ...
    def forward(
        ...
        Args:
          ...
          masks (torch.Tensor, None): Annotations to embed
        ...
        Returns:
          ...
          torch.Tensor: dense embeddings for the Annotations, in the shape Bx(embed_dim)x(embed_H)x(embed_W)
        """
