...
class Sam(nn.Module):
    ...
    decoder to predict object Annotations.
    ...
    Attributes:
        ...
        mask_decoder (MaskDecoder): Predicts object Annotations from the image and prompt embeddings.
    ...
    def __init__(
        ...
        """
        Initialize the Sam class to predict object Annotations from an image and input prompts.
        ...
        Args:
            ...
            prompt_encoder (PromptEncoder): Encodes various types of input prompts.
            mask_decoder (MaskDecoder): Predicts Annotations from the image embeddings and encoded prompts.
