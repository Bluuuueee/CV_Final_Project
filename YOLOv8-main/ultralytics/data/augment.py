...
class BaseTransform:
    ...
    Methods:
        ...
        __call__: Applies all label transformations to an image, instances, and semantic Annotations.
    """
    ...
    def __call__(self, labels):
        """Applies all label transformations to an image, instances, and semantic Annotations."""
...
class Format:
    ...
    Attributes:
        ...
        return_mask (bool): Return instance Annotations for segmentation. Default is False.
        return_keypoint (bool): Return keypoints for pose estimation. Default is False.
        mask_ratio (int): Downsample ratio for Annotations. Default is 4.
        mask_overlap (bool): Whether to overlap Annotations. Default is True.
